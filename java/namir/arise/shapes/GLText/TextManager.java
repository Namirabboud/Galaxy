package namir.arise.shapes.GLText;

/**
 * Created by namir on 4/8/15.
 */
...
/*    public static int sp_Text;
    ...
    public TextManager( Context mContext ){
        ...
        int vshadert = MyGLRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vs_Text);
        int fshadert = MyGLRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fs_Text);
        ...
        mTextureDataHandle = loadTexture( mContext );
    }
    ...
    private int loadTexture( Context context ){
        ...
        //final int id = mContext.getResources().getIdentifier( "R.drawable.font", null,
        // mContext.getPackageName());

        final Bitmap bmp = BitmapFactory.decodeResource( context.getResources(), R.drawable.font_chaka);
